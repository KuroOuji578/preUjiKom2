...
<body>
    ...
    <div id="main-wrapper">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{ asset('vendor') }}/assets/images/users/1.jpg" alt="user" class="rounded-circle" width="31"></a>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-face"></i><span class="hide-menu">MetaData</span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="{{ route('matkul')}}" class="sidebar-link"><i class="mdi mdi-emoticon"></i><span class="hide-menu">Mata Kuliah</span></a></li>
                                <li class="sidebar-item"><a href="{{ route('mahasiswa')}}" class="sidebar-link"><i class="mdi mdi-emoticon-cool"></i><span class="hide-menu">Mahasiswa</span></a></li>
                            </ul>
                        </li>
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer text-center" style="margin-top: 20%">
    ...
    <!--Wave Effects -->
    <script src="{{asset('vendor')}}/dist/js/waves.js"></script>
    <!--Menu sidebar -->
    ...
    <script src="{{asset('vendor')}}/assets/libs/flot/jquery.flot.js"></script>
    ...
    <script src="{{asset('vendor')}}/dist/js/pages/chart/chart-page-init.js"></script>
